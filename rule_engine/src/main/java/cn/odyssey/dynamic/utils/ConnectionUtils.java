...
public class ConnectionUtils {
    ...
    public static Connection getHbaseConn() throws IOException {
        ...
        conf.set("hbase.zookeeper.quorum", config.getString(cn.odyssey.marketing.utils.ConfigNames.HBASE_ZK_QUORUM));
        Connection hbaseConn = ConnectionFactory.createConnection(conf);
        return hbaseConn;
    }

    public static java.sql.Connection getCkConn() throws ClassNotFoundException, SQLException {
        String ckDriver = config.getString(cn.odyssey.marketing.utils.ConfigNames.CK_JDBC_DRIVER);
        String ckUrl = config.getString(cn.odyssey.marketing.utils.ConfigNames.CK_JDBC_URL);
    ...
    public static Jedis getRedisConn() {
        String host = config.getString(cn.odyssey.marketing.utils.ConfigNames.REDIS_HOST);
